...
1. Проверить с пользователем, что новый формовый интерфейс RD-102 открывается без ошибок и сохраняет данные.
2. Добавить текстовые рекомендации по исправлению `missing_scopes` в RD-103.
3. После подтверждения приемки перевести `RD-102` в `TESTING`.
